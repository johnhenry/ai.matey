...
```javascript
import * as ai from "https://cdn.jsdelivr.net/npm/ai.matey@0.0.12/mock/index.mjs";
//...
```
...
```javascript
import * as ai from "https://ga.jspm.io/npm:ai.matey@0.0.12/mock/index.mjs";
//...
```
...
```javascript
import AI from "https://cdn.jsdelivr.net/npm/ai.matey@0.0.12/openai/index.mjs";
const ai = new AI(/* options */);
...
```javascript
import AI from "https://ga.jspm.io/npm:ai.matey@0.0.12/openai/index.mjs";
const ai = new AI(/* options */);
//...
```
