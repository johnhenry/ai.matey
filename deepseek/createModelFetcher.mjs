  ...
  try {
    ...
    const chatModels = data.data
      .filter((model) => {
        ...
        return (modelIdLower.includes("deepseek") || modelIdLower.includes("chat")) &&
               !modelIdLower.includes("instruct") &&
               !modelIdLower.includes("coder") && // Excluding "coder" as per instruction
    ...
    console.error("Error fetching DeepSeek models:", error.message); // Log only message
