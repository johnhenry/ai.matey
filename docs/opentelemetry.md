...
```typescript
import { isOpenTelemetryAvailable, isOpenTelemetryLoaded } from '@johnhenry/aimatey-middleware';
...
```typescript
import { isOpenTelemetryAvailable, createOpenTelemetryMiddleware } from '@johnhenry/aimatey-middleware';
