...
```typescript
/**
 * Error codes for Aimatey errors.
 *
...
Visit http://localhost:3000/aimatey/api/generated/ and check:
...
5. ⏰ **aimatey-types** - Core type definitions
6. ⏰ **aimatey-core** - Bridge and Router
7. ⏰ **aimatey-errors** - Error classes
