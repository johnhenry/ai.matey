---
title: "Tutorials"
description: "Guided tutorials for learning aimatey, from a simple bridge to a production chat API."
---

Learn aimatey through hands-on tutorials, progressing from beginner to advanced topics.

## Beginner Tutorials

Perfect for getting started with aimatey fundamentals:
...
Create a production-ready HTTP API server with Express and aimatey.
...
4. Open an issue on [GitHub](https://github.com/johnhenry/aimatey/issues)
