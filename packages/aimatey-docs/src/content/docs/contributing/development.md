...
description: "Development guide for the aimatey monorepo: building, testing, linting, and creating new packages."
---

Detailed guide for setting up your development environment and working with the aimatey codebase.
...
aimatey uses **npm workspaces** for package management and **Turbo** for build orchestration.
