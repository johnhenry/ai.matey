...
description: "Map of the aimatey monorepo: all 23 published @johnhenry/aimatey-* packages, what each one does, and which ones to install."
---

aimatey is organized as a monorepo of 24 packages — 23 published to npm under the `@johnhenry` scope, plus the private package that builds this documentation site. This modular approach allows you to install only what you need.
...
### [@johnhenry/aimatey-core](/packages/core)
...
**Use when:** Every aimatey project needs this package.
...
### [@johnhenry/aimatey-frontend](/packages/frontend)
...
### [@johnhenry/aimatey-backend](/packages/backend)
...
### [@johnhenry/aimatey-middleware](/packages/middleware)
...
**Use when:** You want models to call MCP server tools through aimatey.
...
- **React Hooks** - React components (see [example](https://github.com/johnhenry/aimatey/tree/main/packages/aimatey-docs/examples/07-advanced-patterns/05-react-integration.ts))
- **SDK Wrappers** - SDK compatibility (see [examples](https://github.com/johnhenry/aimatey/tree/main/packages/aimatey-docs/examples/06-sdk-wrappers))
- **CLI Tools** - Command-line utilities (see [example](https://github.com/johnhenry/aimatey/tree/main/packages/aimatey-docs/examples/07-advanced-patterns/04-cli-tool.ts))

---

**Need help choosing packages?** Check the [Quick Start](/getting-started/quick-start) guide or explore [examples](https://github.com/johnhenry/aimatey/tree/main/packages/aimatey-docs/examples).
