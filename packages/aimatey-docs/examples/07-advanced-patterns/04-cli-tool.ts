 ...
 *
 * Demonstrates:
 * - Building production CLI tools with aimatey
 ...
 *
 * Run:
 *   npx tsx packages/aimatey-docs/examples/07-advanced-patterns/04-cli-tool.ts
 *   npx tsx packages/aimatey-docs/examples/07-advanced-patterns/04-cli-tool.ts "What is TypeScript?"
 *
 * Expected Output:
