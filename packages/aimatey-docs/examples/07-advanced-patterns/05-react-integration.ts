 ...
 *
 * Demonstrates:
 * - Using aimatey with React hooks
 ...
 *   npx tsx packages/aimatey-docs/examples/07-advanced-patterns/05-react-integration.ts
 *
 * Expected Output:
...
function main() {
  displayExampleInfo(
    ...
    'Build AI-powered React applications with aimatey',
    [
      'React application',
