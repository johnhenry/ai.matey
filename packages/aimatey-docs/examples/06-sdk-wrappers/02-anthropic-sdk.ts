 ...
 *
 * Run:
 *   npx tsx packages/aimatey-docs/examples/06-sdk-wrappers/02-anthropic-sdk.ts
 *
 * Expected Output:
...
async function main() {
  ...
  try {
    ...
    const client = new Anthropic({
      bridge, // Magic: routes through aimatey
    ...
    console.log('   ✓ Works with all aimatey features');
