...
### 01. Basics ⭐ (Beginner)
**Learn the fundamentals of aimatey**
 ...
 *
 * Run:
 *   npx tsx packages/aimatey-docs/examples/[category]/[filename].ts
 *
 * Expected Output:
...
- [Contributing](/contributing/overview) - Contribute to aimatey
