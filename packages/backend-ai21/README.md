...
Backend adapter for AI21 Labs API
...
```typescript
import { AI21BackendAdapter } from 'ai.matey.backend.ai21';
import { Bridge } from 'ai.matey.core';
import { OpenAIFrontendAdapter } from 'ai.matey.frontend.openai';

// Create the backend adapter
const backend = new AI21BackendAdapter({
...
The main adapter class for AI21.

#### Constructor

```typescript
new AI21BackendAdapter(config: AI21BackendAdapterConfig)
```
