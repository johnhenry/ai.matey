...
```typescript
import { XAIBackendAdapter } from 'ai.matey.backend.xai';
import { Bridge } from 'ai.matey.core';
import { OpenAIFrontendAdapter } from 'ai.matey.frontend.openai';

// Create the backend adapter
const backend = new XAIBackendAdapter({
...
The main adapter class for xAI.

#### Constructor

```typescript
new XAIBackendAdapter(config: XAIBackendAdapterConfig)
```
