...
Backend adapter for Anyscale Endpoints
...
```typescript
import { AnyscaleBackendAdapter } from 'ai.matey.backend.anyscale';
import { Bridge } from 'ai.matey.core';
import { OpenAIFrontendAdapter } from 'ai.matey.frontend.openai';

// Create the backend adapter
const backend = new AnyscaleBackendAdapter({
...
The main adapter class for Anyscale.

#### Constructor

```typescript
new AnyscaleBackendAdapter(config: AnyscaleBackendAdapterConfig)
```
