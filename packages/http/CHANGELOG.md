...
- Updated dependencies [8f9cd1c]
  - @johnhenry/aimatey-types@0.4.0
  - @johnhenry/aimatey-http-core@0.3.0
...
> Previously published as `aimatey-http`, last unscoped version `0.3.1`.
